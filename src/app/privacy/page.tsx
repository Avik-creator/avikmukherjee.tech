  ...
  return (
    <article className="prose mt-8 pb-16 dark:prose-invert">
      ...
      <div className="mt-4 space-y-4">
        ...
        <h2 className="title text-xl">What Information I Collect (Hint: Not Much)</h2>
        <p>
        ...
        <h2 className="title text-xl">How I Use the Info</h2>
        ...
        <h2 className="title text-xl">Sharing Your Info (Spoiler: I Don&apos;t)</h2>
        <p>
        ...
        <h2 className="title text-xl">Security (The Internet Isn&apos;t Perfect)</h2>
        <p>
        ...
        <h2 className="title text-xl">Got Questions?</h2>
        <p>
          If you have any questions, concerns, or just want to say hi, drop me
          an email at{" "}
          <Link href="mailto:avikm744@gmail.com" className="underline">avikm744@gmail.com</Link> or use
